...
public final class Staticvalue {
	...
	public static final int SSN_T_MAX = 4;
	public static final int SSN_T_MIN = 1;
	...
	public static final int DISCOUNT_DISABLED = 2;
	public static final int DISCOUNT_VETERAN = 3;
